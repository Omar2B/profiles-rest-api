...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        a_viewset = [
            'Uses actions (list, create, retrieve, update, partila update and delete)', 
            'Automatically masp to URLs using Routers', 
...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = ( permissions.UpdateOwProfile, )
